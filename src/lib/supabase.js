...
'Assisted Dips',
  ...
  'Hammer Strength Pec Deck Machine',
  ...
  'Triceps Ext Rope',
  'Triceps Pushdowns with Vbar',
  ],
  Pull:  ['Back Row Machine',
  'Bent Over Back Row Bar',
  'Cable Curls Dual Stack',
  'Cable Curls EZ Bar',
  ...
  'Chest Supported Row Dumbbell WG',
  'Dumbbell Curls',
  'Face Pulls',
  'Hammer Curls Dumbbells',
  'Hammer Strength Back Row Neutral Grip',
  'Hammer Strength Back Row Wide Grip',
  'Hammer Strength Lat Pulldown',
  'Hammer Strength Preacher Curl',
  'Hammer Strength Rear Delt Fly Machine',
